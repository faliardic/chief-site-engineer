...
Adim 160 icin export helper result contract wrapper API boundary veya implementation readiness review ele alinabilir. Hard validation ve `blocked` status henuz eklenmemelidir.
