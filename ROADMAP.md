...
Adim 161 icin export helper result contract wrapper implementation readiness review veya podcast hazirlik dokumantasyonu ele alinabilir. Hard validation ve `blocked` status henuz eklenmemelidir.
