...
Adim 180 icin export result report JSON-ready presentation formatter boundary plan ele alinabilir. Hard validation ve `blocked` status henuz eklenmemelidir.
